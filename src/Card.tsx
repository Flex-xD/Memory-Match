...
type CardProps = {
    ...
    handleCardMatch:(key:number) => void;
    flipped?:boolean 
};

export default function Card(props: CardProps) {
    const {  CardIndex, value ,flipped = false ,  handleCardFlip , handleCardMatch} = props

    return (
        <div
            onClick={()=>{handleCardFlip(CardIndex); handleCardMatch(CardIndex)}}
